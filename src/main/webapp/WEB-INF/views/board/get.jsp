          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form role="form" class="user" action="/board/register" method="post">
                ...
                <label>Content</label>
                	<textarea class="form-control" rows="10" name='content' value='<c:out value="${board.content}"/>' readonly="readonly"></textarea>
                  <!-- <input type="email" class="form-control form-control-user" id="exampleInputEmail" placeholder="Text area"> -->
                </div>
